        ...
        onSubmit: async (values, { resetForm }) => {
            try {
                const productRequest: ProductI = {
                    ...
                    quantityAvailable: parseFloat(values.price),
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6} md={3}>
                            <TextField
                                ...
                                helperText={formik.touched.nameofProduct && formik.errors.nameofProduct ? formik.errors.nameofProduct : ''}
                                error={formik.touched.nameofProduct && Boolean(formik.errors.nameofProduct)}
                            />
                        </Grid>
                        ...
                        <Grid item xs={12} sm={6} md={3}>
                            <TextField
                                ...
                                onChange={formik.handleChange}
                                onBlur={formik.handleBlur}
                                helperText={formik.touched.quantityAvailable && formik.errors.quantityAvailable ? formik.errors.quantityAvailable : ''}
